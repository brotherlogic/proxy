...
func (x *GithubKey) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GithubKey) ProtoMessage() {}

func (x *GithubKey) ProtoReflect() protoreflect.Message {
	mi := &file_proxy_proto_msgTypes[0]
...
// Deprecated: Use GithubKey.ProtoReflect.Descriptor instead.
func (*GithubKey) Descriptor() ([]byte, []int) {
	return file_proxy_proto_rawDescGZIP(), []int{0}
}

func (x *GithubKey) GetKey() string {
	if x != nil {
		return x.Key
	}
	return ""
...
var file_proxy_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x78, 0x79, 0x22, 0x1d, 0x0a, 0x09, 0x47, 0x69, 0x74, 0x68, 0x75, 0x62, 0x4b, 0x65,
	0x79, 0x12, 0x10, 0x0a, 0x03, 0x6b, 0x65, 0x79, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03,
	0x6b, 0x65, 0x79, 0x42, 0x25, 0x5a, 0x23, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x62, 0x72, 0x6f, 0x74, 0x68, 0x65, 0x72, 0x6c, 0x6f, 0x67, 0x69, 0x63, 0x2f, 0x70,
...
var file_proxy_proto_goTypes = []interface{}{
	(*GithubKey)(nil), // 0: proxy.GithubKey
}
